...
<head>
	...
	<nav class="navbar navbar-expand-sm fixed-top" >
		<div class="container-fluid">
			<h1 class="navbar-brand">Edit Admin</h1>
			<?php
...
<body>
<h3 style="text-align: center; margin-top: 5%;">Edit admin</h3>
	<?php
...
<div class="container" style="margin-top: 2%;">
	<hr>
     <?php echo form_open('UserAction/editAdmin/'.$editing['id_admin']); ?>
    <form action="" method="post">
        <div class="form-group">
          <label for="name">Name</label>
          <input type="text" class="form-control" name="name" required="" value="<?php echo !empty($editing['admin_name'])?$editing['admin_name']:''; ?>">
            <?php echo form_error('name','<span class="help-block">','</span>'); ?>
        </div>
        <div class="form-group">
            <label for="username">Username</label>
            <input type="text" class="form-control" name="username" required="" value="<?php echo !empty($editing['adm_user'])?$editing['adm_user']:''; ?>">
          <?php echo form_error('name','<span class="help-block">','</span>'); ?>
        </div>
        <div class="form-group">
            <label for="email">Email</label>
            <input type="email" class="form-control" name="email" required="" value="<?php echo !empty($editing['adm_email'])?$editing['adm_email']:''; ?>">
